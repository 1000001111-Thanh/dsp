...
def test_srs_channel_estimator(test_case_number):
    # pylint: disable=too-many-locals
    ...
    srs_ch_est = SrsChannelEstimator(chest_params)
    ...
    for ue_idx in range(num_srs_ues):
        ...
        assert np.isclose(srs_report[ue_idx].wideband_snr, wideband_snr_ref, atol=0.1)
